...
(function(process) {
  ...
  Vex.Flow.sanitizeDuration = function(duration) {
    ...
    if (Vex.Flow.durationToTicks.durations[duration] === undefined) {
      throw new Vex.RERR('BadArguments', 'The provided duration is not valid');
    }
    return duration;
  };
    ...
    Stave.prototype = {
      ...
      getModifierXShift: function(index) {
        if (typeof index === 'undefined')
          index = this.glyphs.length - 1;
        if (typeof index !== 'number')
          new Vex.RERR("InvalidIndex", "Must be of number type");
        ...
        if (bar_x_shift > 0)
          bar_x_shift += this.options.vertical_bar_width + 10;
        return bar_x_shift;
      },
  ...
  Vex.Flow.StaveConnector = (function() {
    ...
    StaveConnector.prototype = {
      ...
      setType: function(type) {
        if (type >= StaveConnector.type.SINGLE_RIGHT && type <= StaveConnector.type.THIN_DOUBLE)
          this.type = type;
        return this;
      },
      ...
      draw: function() {
        ...
        if (this.type !== StaveConnector.type.BRACE && this.type !== StaveConnector.type.BOLD_DOUBLE_LEFT && this.type !== StaveConnector.type.BOLD_DOUBLE_RIGHT) {
        ...
        if (this.text !== undefined) {
          ...
          var y = (this.top_stave.getYForLine(0) + this.bottom_stave.getBottomLineY()) / 2 + this.text_options.shift_y;
  ...
  Vex.Flow.TickContext = (function() {
    ...
    TickContext.prototype = {
      ...
      setPixelsUsed: function(pixelsUsed) {
  ...
  Vex.Flow.Note = (function() {
    ...
    Note.plotMetrics = function(ctx, note, yPos) {
      ...
      stroke(xStart - note.getXShift(), xStart, "#DDD");
    ...
    Vex.Inherit(Note, Vex.Flow.Tickable, {
      ...
      setExtraLeftPx: function(x) {
        this.extraLeftPx = x;
        return this;
      },
      setExtraRightPx: function(x) {
        this.extraRightPx = x;
        return this;
      },
      shouldIgnoreTicks: function() {
      ...
      setModifierContext: function(mc) {
        this.modifierContext = mc;
        return this;
      },
  ...
  Vex.Flow.NoteHead = (function() {
    var NoteHead = function(head_options) {
      if (arguments.length > 0)
        this.init(head_options);
    };
    function L() {
      if (NoteHead.DEBUG)
        Vex.L("Vex.Flow.NoteHead", arguments);
    }
    function drawSlashNoteHead(ctx, duration, x, y, stem_direction) {
      ...
      if (!fill)
        x -= (Vex.Flow.STEM_WIDTH / 2) * stem_direction;
      ctx.beginPath();
      ctx.moveTo(x, y + 11);
      ctx.lineTo(x, y + 1);
  ...
  Vex.Flow.StemmableNote = (function() {
    ...
    function L() {
      if (StemmableNote.DEBUG)
        Vex.L("Vex.Flow.StemmableNote", arguments);
    }
  ...
  Vex.Flow.StaveNote = (function() {
    ...
    function L() {
      if (StaveNote.DEBUG)
        Vex.L("Vex.Flow.StaveNote", arguments);
    }
    var Stem = Vex.Flow.Stem;
    ...
    Vex.Inherit(StaveNote, Vex.Flow.StemmableNote, {
      ...
      buildStem: function() {
        ...
        var stem = new Stem({y_extend: y_extend});
        if (this.isRest()) {
          stem.hide = true;
        }
        this.setStem(stem);
      ...
      getModifierStartXY: function(position, index) {
        ...
        } else if (position == Vex.Flow.Modifier.Position.BELOW || position == Vex.Flow.Modifier.Position.ABOVE) {
  ...
  Vex.Flow.TabNote = (function() {
    function TabNote(tab_struct, draw_stem) {
      if (arguments.length > 0)
        this.init(tab_struct, draw_stem);
    }
    var Stem = Vex.Flow.Stem;
    Vex.Inherit(TabNote, Vex.Flow.StemmableNote, {
      ...
      drawFlag: function() {
        ...
        if (this.glyph.flag && render_flag) {
          ...
          Vex.Flow.renderGlyph(this.context, flag_x, flag_y, this.render_options.glyph_font_scale, flag_code);
        }
      },
      drawModifiers: function() {
        this.modifiers.forEach(function(modifier) {
          if (modifier.getCategory() === 'dots' && !this.render_options.draw_dots)
            return;
  ...
  Vex.Flow.GhostNote = (function() {
    ...
    Vex.Inherit(GhostNote, Vex.Flow.StemmableNote, {
      ...
      setStave: function(stave) {
        GhostNote.superclass.setStave.call(this, stave);
      },
  ...
  Vex.Flow.ClefNote = (function() {
    function ClefNote(clef, size, annotation) {
      this.init(clef, size, annotation);
    }
  ...
  Vex.Flow.TimeSigNote = (function() {
    function TimeSigNote(timeSpec, customPadding) {
      if (arguments.length > 0)
        this.init(timeSpec, customPadding);
    }
    ...
    Voice.prototype = {
      ...
      addTickable: function(tickable) {
        if (!tickable.shouldIgnoreTicks()) {
          ...
          if ((this.mode == Vex.Flow.Voice.Mode.STRICT || this.mode == Vex.Flow.Voice.Mode.FULL) && this.ticksUsed.greaterThan(this.totalTicks)) {
  ...
  Vex.Flow.Modifier = (function() {
    ...
    function L() {
      if (Modifier.DEBUG)
        Vex.L("Vex.Flow.Modifier", arguments);
    }
    Modifier.Position = {
      LEFT: 1,
      RIGHT: 2,
    ...
    Modifier.prototype = {
      ...
      getSpacingFromNextModifier: function() {
  ...
  Vex.Flow.ModifierContext = (function() {
    function ModifierContext() {
      ...
      this.PREFORMAT = [Vex.Flow.StaveNote, Vex.Flow.Dot, Vex.Flow.FretHandFinger, Vex.Flow.Accidental, Vex.Flow.GraceNoteGroup, Vex.Flow.Stroke, Vex.Flow.StringNumber, Vex.Flow.Articulation, Vex.Flow.Ornament, Vex.Flow.Annotation, Vex.Flow.Bend, Vex.Flow.Vibrato];
      this.POSTFORMAT = [Vex.Flow.StaveNote];
    }
    function L() {
      if (ModifierContext.DEBUG)
        Vex.L("Vex.Flow.ModifierContext", arguments);
    }
  ...
  Vex.Flow.Accidental = (function() {
    ...
    function L() {
      if (Accidental.DEBUG)
        Vex.L("Vex.Flow.Accidental", arguments);
    }
    ...
    Accidental.format = function(accidentals, state) {
      ...
      for (i = 0; i < line_list.length; i++) {
        ...
        switch (group_length) {
          case 3:
            if ((end_case == "a") && (line_list[group_start + 1].line - line_list[group_start + 2].line == 0.5) && (line_list[group_start].line - line_list[group_start + 1].line != 0.5))
              end_case = "second_on_bottom";
            break;
          case 4:
            if ((!checkCollision(line_list[group_start], line_list[group_start + 2])) && (!checkCollision(line_list[group_start + 1], line_list[group_start + 3])))
              end_case = "spaced_out_tetrachord";
            break;
          case 5:
            if ((end_case == "b") && (!checkCollision(line_list[group_start + 1], line_list[group_start + 3])))
              end_case = "spaced_out_pentachord";
            if ((end_case == "spaced_out_pentachord") && (!checkCollision(line_list[group_start], line_list[group_start + 2])) && (!checkCollision(line_list[group_start + 2], line_list[group_start + 4])))
              end_case = "very_spaced_out_pentachord";
            break;
          case 6:
            if ((!checkCollision(line_list[group_start], line_list[group_start + 3])) && (!checkCollision(line_list[group_start + 1], line_list[group_start + 4])) && (!checkCollision(line_list[group_start + 2], line_list[group_start + 5])))
              end_case = "spaced_out_hexachord";
            if ((!checkCollision(line_list[group_start], line_list[group_start + 2])) && (!checkCollision(line_list[group_start + 2], line_list[group_start + 4])) && (!checkCollision(line_list[group_start + 1], line_list[group_start + 3])) && (!checkCollision(line_list[group_start + 3], line_list[group_start + 5])))
      ...
      line_list.forEach(function(line) {
        if (line.width > column_widths[line.column])
          column_widths[line.column] = line.width;
      });
  ...
  Vex.Flow.Formatter = (function() {
    ...
    function L() {
      if (Formatter.DEBUG)
        Vex.L("Vex.Flow.Formatter", arguments);
    }
    ...
    Formatter.prototype = {
      ...
      createModifierContexts: function(voices) {
        var contexts = createContexts(voices, Vex.Flow.ModifierContext, function(tickable, context) {
      ...
      createTickContexts: function(voices) {
        var contexts = createContexts(voices, Vex.Flow.TickContext, function(tickable, context) {
  ...
  Vex.Flow.Articulation = (function() {
    ...
    function L() {
      if (Articulation.DEBUG)
        Vex.L("Vex.Flow.Articulation", arguments);
    }
    var Modifier = Vex.Flow.Modifier;
    ...
    Vex.Inherit(Articulation, Modifier, {
      init: function(type) {
        ...
        this.render_options = {font_scale: 38};
      ...
      draw: function() {
        ...
        var stave = this.note.getStave();
        var is_on_head = (this.position === Modifier.Position.ABOVE && stem_direction === Vex.Flow.StaveNote.STEM_DOWN) || (this.position === Modifier.Position.BELOW && stem_direction === Vex.Flow.StaveNote.STEM_UP);
  ...
  Vex.Flow.TimeSignature = (function() {
    ...
    Vex.Inherit(TimeSignature, Vex.Flow.StaveModifier, {
      ...
      parseTimeSpec: function(timeSpec) {
        ...
        return {
          num: true,
          glyph: this.makeTimeSignatureGlyph(topNums, botNums)
        };
      },
      makeTimeSignatureGlyph: function(topNums, botNums) {
        ...
        glyph.renderToStave = function(x) {
          ...
          for (i = 0; i < this.topGlyphs.length; ++i) {
            g = this.topGlyphs[i];
            Vex.Flow.Glyph.renderOutline(this.context, g.metrics.outline, g.scale, start_x + g.x_shift, this.stave.getYForLine(that.topLine) + 1);
          ...
          for (i = 0; i < this.botGlyphs.length; ++i) {
            ...
            Vex.Flow.Glyph.renderOutline(this.context, g.metrics.outline, g.scale, start_x + g.x_shift, this.stave.getYForLine(that.bottomLine) + 1);
            start_x += g.getMetrics().width;
          }
        };
        return glyph;
  ...
  Vex.Flow.Clef = (function() {
    ...
    function L() {
      if (Vex.Flow.Clef.DEBUG)
        Vex.L("Vex.Flow.Clef", arguments);
    }
    Clef.types = {
      "treble": {
        code: "v83",
  ...
  Vex.Flow.Music = (function() {
    ...
    Music.canonical_notes = ["c", "c#", "d", "d#", "e", "f", "f#", "g", "g#", "a", "a#", "b"];
    Music.diatonic_intervals = ["unison", "m2", "M2", "m3", "M3", "p4", "dim5", "p5", "m6", "M6", "b7", "M7", "octave"];
    ...
    Music.prototype = {
      ...
      createScaleMap: function(keySignature) {
        ...
        if (!scaleName)
          throw new Vex.RERR("BadArguments", "Unsupported key type: " + keySignature);
  ...
  Vex.Flow.Renderer = (function() {
    ...
    Renderer.buildContext = function(sel, backend, width, height, background) {
    ...
    RaphaelContext.prototype = {
      ...
      save: function() {
        this.state_stack.push({
          state: {font_family: this.state.font_family},
          attributes: {
  ...
  Vex.Flow.SVGContext = (function() {
    ...
    SVGContext.prototype = {
      ...
      openGroup: function(cls, id, attrs) {
        ...
        this.parent = group;
        if (cls)
          group.setAttribute("class", SVGContext.addPrefix(cls));
        if (id)
          group.setAttribute("id", SVGContext.addPrefix(id));
      ...
      measureText: function(text) {
        var index = text + this.attributes["font-style"] + this.attributes["font-family"] + this.attributes["font-weight"] + this.attributes["font-size"];
  ...
  Vex.Flow.StaveSection = (function() {
    ...
    Vex.Inherit(StaveSection, Modifier, {
      ...
      setStaveSection: function(section) {
        this.section = section;
        return this;
      },
      setShiftX: function(x) {
  ...
  Vex.Flow.StaveText = (function() {
    function StaveText(text, position, options) {
      if (arguments.length > 0)
        this.init(text, position, options);
    }
    var Modifier = Vex.Flow.Modifier;
  ...
  Vex.Flow.BarNote = (function() {
    ...
    function L() {
      if (BarNote.DEBUG)
        Vex.L("Vex.Flow.BarNote", arguments);
    }
      ...
      draw: function() {
        ...
        if (this.location == Tuplet.LOCATION_TOP) {
          ...
          for (i = 0; i < this.notes.length; ++i) {
            var top_y = this.notes[i].getStemDirection() === Vex.Flow.Stem.UP ? this.notes[i].getStemExtents().topY - 10 : this.notes[i].getStemExtents().baseY - 20;
            if (top_y < this.y_pos)
              this.y_pos = top_y;
          }
        } else {
          ...
          for (i = 0; i < this.notes.length; ++i) {
            var bottom_y = this.notes[i].getStemDirection() === Vex.Flow.Stem.UP ? this.notes[i].getStemExtents().baseY + 20 : this.notes[i].getStemExtents().topY + 10;
  ...
  Vex.Flow.FretHandFinger = (function() {
    ...
    Vex.Inherit(FretHandFinger, Modifier, {
      ...
      setFretHandFinger: function(number) {
        this.finger = number;
        return this;
      },
  ...
  Vex.Flow.StringNumber = (function() {
    ...
    Vex.Inherit(StringNumber, Modifier, {
      ...
      setStringNumber: function(number) {
        this.string_number = number;
        return this;
      },
      setOffsetX: function(x) {
      ...
      setLastNote: function(note) {
        this.last_note = note;
        return this;
      },
      setDashed: function(dashed) {
        this.dashed = dashed;
        return this;
      },
      draw: function() {
  ...
  Vex.Flow.Crescendo = (function() {
    ...
    function L() {
      if (Crescendo.DEBUG)
        Vex.L("Vex.Flow.Crescendo", arguments);
    }
  ...
  Vex.Flow.Ornament = (function() {
    ...
    function L() {
      if (Ornament.DEBUG)
        Vex.L("Vex.Flow.Ornament", arguments);
    }
    var Modifier = Vex.Flow.Modifier;
  ...
  Vex.Flow.PedalMarking = (function() {
    ...
    function L() {
      if (PedalMarking.DEBUG)
        Vex.L("Vex.Flow.PedalMarking", arguments);
    }
    PedalMarking.GLYPHS = {
      "pedal_depress": {
        code: "v36",
  ...
  Vex.Flow.TextBracket = (function() {
    function TextBracket(bracket_data) {
      if (arguments.length > 0)
        this.init(bracket_data);
    }
    function L() {
      if (TextBracket.DEBUG)
        Vex.L("Vex.Flow.TextBracket", arguments);
    }
    ...
    TextBracket.prototype = {
      ...
      draw: function() {
        ...
        if (this.render_options.dashed) {
          Vex.Flow.Renderer.drawDashedLine(ctx, start_x, line_y, end_x, line_y, this.render_options.dash);
          if (this.render_options.show_bracket) {
            Vex.Flow.Renderer.drawDashedLine(ctx, end_x, line_y + (1 * this.position), end_x, line_y + bracket_height, this.render_options.dash);
          }
        } else {
          ctx.beginPath();
  ...
  Vex.Flow.TextDynamics = (function() {
    ...
    function L() {
      if (TextDynamics.DEBUG)
        Vex.L("Vex.Flow.TextDynamics", arguments);
    }
    TextDynamics.GLYPHS = {
      "f": {
        code: "vba",
    ...
    Vex.Inherit(TextDynamics, Vex.Flow.Note, {
      init: function(text_struct) {
        ...
        this.line = text_struct.line || 0;
        this.glyphs = [];
        Vex.Merge(this.render_options, {glyph_font_size: 40});
      ...
      preFormat: function() {
        ...
        this.sequence.split('').forEach(function(letter) {
          ...
          if (!glyph_data)
            throw new Vex.RERR("Invalid dynamics character: " + letter);
  ...
  Vex.Flow.GraceNoteGroup = (function() {
    function GraceNoteGroup(grace_notes, config) {
      if (arguments.length > 0)
        this.init(grace_notes, config);
    }
    GraceNoteGroup.CATEGORY = "gracenotegroups";
    function L() {
      if (GraceNoteGroup.DEBUG)
        Vex.L("Vex.Flow.GraceNoteGroup", arguments);
    }
